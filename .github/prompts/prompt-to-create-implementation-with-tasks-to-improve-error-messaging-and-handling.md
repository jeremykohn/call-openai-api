Create an implementation plan to add the feature that is described in .github/specs/application-specifications-improve-error-messaging-and-handling.md. If something in that file is vague, unclear, or ambiguous, pause and ask me for guidance before you continue.
...
Save the implementation plan to a new file .github/implementation-plans-with-tasks/implementation-plan-with-tasks-to-improve-error-messaging-and-handling.md.
